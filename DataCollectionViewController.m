...
- (void)viewDidLoad
{
	...
	[self.navigationItem setRightBarButtonItem:[[[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"CommentsTitleKey", @"") style:UIBarButtonItemStylePlain target:self action:@selector(showComments)] autorelease]];
