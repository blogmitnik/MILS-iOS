...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *hideKeyboardButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"SaveCommentTitleKey", @"") style:UIBarButtonItemStylePlain target:self action:@selector(hideKeyboard)];      
