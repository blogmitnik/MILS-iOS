...
- (void)viewDidLoad {
	...
	NSLog(@"ItemPropertiesViewController:viewdidLoad");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	UITextView *tv = [[UITextView alloc]initWithFrame:CGRectMake(5, 5, 310, 50)];
    [cell.contentView addSubview:tv];
	
	if ([indexPath row] == 0) tv.text = @"Name";
	if ([indexPath row] == 1) tv.text = @"Description";
