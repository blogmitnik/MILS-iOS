		...
		if (newItems > 0) {
			...
			if (![AppModel sharedAppModel].hasSeenMapTabTutorial) {
				...
				[appDelegate.tutorialViewController showTutorialPopupPointingToTabForViewController:self.navigationController 
																							  ...
																							  title:NSLocalizedString(@"NewGPSLocationTitleKey", @"") 
																							message:NSLocalizedString(@"GPSLocationMessageTitleKey", @"")];						
...
- (void)mapView:(MKMapView *)aMapView didSelectAnnotationView:(MKAnnotationView *)view {
	...
	if (location.allowsQuickTravel)	{
		[buttonTitles addObject: NSLocalizedString(@"QuickTravelTitleKey", @"")];
		cancelButtonIndex = 1;
	}
	[buttonTitles addObject: NSLocalizedString(@"CancelTitleKey", @"")];
