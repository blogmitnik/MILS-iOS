...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([currentNoteList count] == 0 && indexPath.row == 0){
        ...
        cell.textLabel.text = NSLocalizedString(@"NoNotesTitleKey", @"");
        cell.detailTextLabel.text = NSLocalizedString(@"AddOneNoteTitleKey", @"");
    ...
    cell.commentsLbl.text = [NSString stringWithFormat:@"%d %@",[currNote.comments count], NSLocalizedString(@"CommentsTitleKey", @"")];
