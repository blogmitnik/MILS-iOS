...
- (void)viewDidLoad {	
	...
	*/
	...
	[[(MILSAppDelegate *)[[UIApplication sharedApplication] delegate] window] addSubview:ARviewController.view];
	
	//Add a close button
	UIButton *closeButton = [UIButton buttonWithType:UIButtonTypeRoundedRect];
	[closeButton setTitle:NSLocalizedString(@"CloseTitleKey", @"") forState:UIControlStateNormal];	
    ...
    [[(MILSAppDelegate *)[[UIApplication sharedApplication] delegate] window] makeKeyAndVisible];	
