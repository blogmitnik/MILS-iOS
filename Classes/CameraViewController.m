...
- (void)viewDidLoad {
    ...
    [profileButton setTitle:@"TakeProfilePictureKey" forState:UIControlStateNormal];
    [profileButton setTitle:@"TakeProfilePictureKey" forState:UIControlStateHighlighted];    
